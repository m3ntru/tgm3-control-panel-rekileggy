...
import "./ElevatedView.css";

export const ElevatedView = (props) => {
  const colorlist = {
  ...
  const {username, color, price, message, length} = props;
  if (parseInt(price) >= 300000) {
    priceResult = 300000;
  }
  if (parseInt(price) >= 150000 && parseInt(price) < 300000) {
    priceResult = 150000;
  }
  if (parseInt(price) >= 75000 && parseInt(price) < 150000) {
    priceResult = 75000;
  }
  if (parseInt(price) >= 30000 && parseInt(price) < 75000) {
    priceResult = 30000;
  }
  if (parseInt(price) >= 1 && parseInt(price) < 30000) {
    priceResult = 15000;
  }
  return (
    <div
